# COPYRIGHT NOTICE
# Code inspired/copied from Beanstalk CLI/tools to facilitate making this Gem
...
module Feefi::AWS
  module Deploy
    ...
    #@config is presumed to exist to use this module. this config
    #contains all necc. info
